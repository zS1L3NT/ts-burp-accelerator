...
const iter = async (index: number, char: string) => {
	return await Sess.req`
		GET / HTTP/2
		Host: 0a43003a04cf79b48039177c0016009e.web-security-academy.net
		...
		Referer: https://0a43003a04cf79b48039177c0016009e.web-security-academy.net/filter?category=Accessories
